...
assert.match(summaryHtml, /Assessed evidence may legitimately contain zero practice observations/);
assert.match(summaryHtml, /Emerging practices evidence assessment summary/);
...
assert.match(html, /Filter emerging practices by selection condition/);
...
assert.match(filtered, /1 evidence-backed practice observation · context/);
...
assert.match(renderPracticeObservations([], "learning", "main", summary), /No emerging practices match the learning selection condition/);
assert.match(renderPracticeObservations([], null, "main", summary), /No emerging practices are available for this projection/);

console.log("Emerging Practices rendering, traceability, filtering, and assessment summary contract is stable");
