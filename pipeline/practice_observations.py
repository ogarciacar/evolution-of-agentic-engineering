...
projection. Similar observations across projections intentionally remain
independent; this model does not represent canonical or aggregated practices.
"""
...
class PracticeObservation:
    ...
    def __post_init__(self) -> None:
        for field_name in ("id", "projection_id", "use_case", "problem", "reported_practice"):
